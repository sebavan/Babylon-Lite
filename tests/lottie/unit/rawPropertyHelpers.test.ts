...
import { GetInitialColorValue, GetInitialScalarValue, GetInitialVectorValues, GetInitialBezierData } from "../../../packages/babylon-lite-lottie/src/parsing/rawPropertyHelpers";
import type {
    RawBezier,
    ...
    RawScalarProperty,
    RawVectorProperty,
} from "../../../packages/babylon-lite-lottie/src/parsing/rawTypes";
